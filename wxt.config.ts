...
export default defineConfig({
  ...
  manifest: {
    ...
    host_permissions: [
      ...
      'https://www.bilibili.com/*', 'https://api.bilibili.com/*', 'https://*.hdslb.com/*',
      'https://news.ycombinator.com/*', 'https://arxiv.org/*',
      'https://bsky.app/*', 'https://public.api.bsky.app/*', 'https://cdn.bsky.app/*',
      'https://i.ytimg.com/*', 'https://pbs.twimg.com/*',
    ],
