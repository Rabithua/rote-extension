export const en = {
  addPlatformTag: 'Add platform tag automatically', platformTagHint: 'Add X or GitHub for the source platform; duplicate tags are added only once.',
  ...
  connectionHint: 'Connect once. Save posts from X and public projects from GitHub.', apiUrl: 'Rote service address',
  ...
  retry: 'Retry', reconcile: 'Check in Rote', close: 'Close', openProject: 'Open project', openSource: 'Open original post', settingsLink: 'Open settings',
  emptyTitle: 'A place for what catches your eye', emptyBody: 'Choose “Save to Rote” in an X share menu or beside Star on a GitHub project.',
...
export const zh: Record<MessageKey, string> = {
  addPlatformTag: '自动添加平台标签', platformTagHint: '按采集平台添加 X 或 GitHub 标签，与默认标签去重。',
  ...
  connectionHint: '连接一次，即可保存 X 帖子和 GitHub 公开项目。', apiUrl: 'Rote 服务地址',
  ...
  retry: '重试', reconcile: '核对 Rote 中的结果', close: '关闭', openProject: '打开项目', openSource: '打开原帖', settingsLink: '打开设置',
  emptyTitle: '记下浏览时的灵光一现', emptyBody: '在 X 分享菜单或 GitHub 项目的 Star 旁，点击「保存到 Rote」。',
