export const en = {
  addPlatformTag: 'Add platform tag automatically', platformTagHint: 'Add X, GitHub or YouTube for the source platform; duplicate tags are added only once.',
  ...
  connectionHint: 'Connect once. Save X posts, public GitHub projects and YouTube videos.', apiUrl: 'Rote service address',
  ...
  emptyTitle: 'A place for what catches your eye', emptyBody: 'Choose “Save to Rote” on X, a GitHub project, or a YouTube video.',
...
export const zh: Record<MessageKey, string> = {
  addPlatformTag: '自动添加平台标签', platformTagHint: '按采集平台添加 X、GitHub 或 YouTube 标签，与默认标签去重。',
  ...
  connectionHint: '连接一次，即可保存 X 帖子、GitHub 公开项目和 YouTube 视频。', apiUrl: 'Rote 服务地址',
  ...
  emptyTitle: '记下浏览时的灵光一现', emptyBody: '在 X、GitHub 项目或 YouTube 视频上点击「保存到 Rote」。',
